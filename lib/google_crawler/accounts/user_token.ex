defmodule GoogleCrawler.Accounts.UserToken do
  use Ecto.Schema
  import Ecto.Query
  ...
  def token_and_context_query(token, context) do
    from GoogleCrawler.Accounts.UserToken, where: [token: ^token, context: ^context]
  end
  ...
  def user_and_contexts_query(user, :all) do
    from t in GoogleCrawler.Accounts.UserToken, where: t.user_id == ^user.id
  end

  def user_and_contexts_query(user, [_ | _] = contexts) do
    from t in GoogleCrawler.Accounts.UserToken,
